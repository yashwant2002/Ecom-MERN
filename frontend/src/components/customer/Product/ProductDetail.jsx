...
import { Rating, Button, Grid, Box, Grid2, LinearProgress } from "@mui/material";
    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className=" lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2">
              ...
              <h1 className="text-lg lg:text-xl text-gray-900 opacity-60 pt-3">
                Men Printed Cotton Blend Ethnic Dress
              </h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                ...
                <p className=" opacity-50 text-sm">177 Rating</p>
                <p className=" ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">100 Reviews</p>
                </div>
              </div>
                ...
                <Grid container spacing={7}>
                  ...
                  <Grid item xs={5}>
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <p className="opacity-60">100 Ratings</p>
                    </div>
        ...
        <section className="pt-10">
              <h1 className="py-5 text-xl font-bold">Related Products</h1>
