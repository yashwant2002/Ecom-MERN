        ...
        >
          <div>
            <div className="flex h-16 items-center">
              ...
              {/* Logo */}
              <div className="ml-4 font-extrabold text-2xl flex lg:ml-0">
                LOGO
              </div>
                  ...
                  {navigation.categories.map((category) => (
                    <Popover key={category.name} className="flex">
                      <div className="relative flex">
                        <PopoverButton 
                          className="relative z-10 group-hover:w-full transition-all duration-200 -mb-px flex items-center border-b-4 border-transparent pt-px text-sm font-medium text-gray-700 ease-out hover:text-gray-800 hover:border-indigo-600"
